...
const meta = {
  title:
    'Routes/:teamId ⁄ :projectId ⁄ web-analytics/components/GeneralWebAnalyticsSection/components/MedianSessionTimeTabTrigger',
  component: MedianSessionTimeTabTrigger,
  parameters: {},
} satisfies Meta<typeof MedianSessionTimeTabTrigger>;
