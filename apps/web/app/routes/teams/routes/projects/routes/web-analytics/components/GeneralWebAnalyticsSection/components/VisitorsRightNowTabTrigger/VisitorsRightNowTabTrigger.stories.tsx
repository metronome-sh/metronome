...
const meta = {
  title:
    'Routes/:teamId ⁄ :projectId ⁄ web-analytics/components/GeneralWebAnalyticsSection/components/VisitorsRightNowTabTrigger',
  component: VisitorsRightNowTabTrigger,
  parameters: {},
} satisfies Meta<typeof VisitorsRightNowTabTrigger>;
